...
{ 
	...
	public function getAction()
	{
		//try {
			...
			$current_url = (string)self::getClassLmsTable()->getCurrentUrl($class_session_id);
		    		
		//	echo $class_session_id;
			//print_r($_SESSION);
			$classData = self::getClassSessionTable()->getById($class_session_id);
			//print_r($classData);
			//echo count($classData)." ".$class_session_id;
			...
			$this->output['class_status'] = false;
				...
				if ( (  self::getClassSessionTable()->isRunningExtra($class_session_id) ) != "" )
	...
	public function postAction()
	{
        ...
        exec("/opt/lampp/bin/php /opt/lampp/htdocs/schoolerp/soap/ctp/application/helpers/Notification_Student.php '$notifydata3' > /dev/null &");
        		...
        		case 'WHITEBOARD':
				echo self::getWhiteBoardSessionTable()->checkByWcAndTeacher(self::getWhiteBoardConfigIp(), $teacher_id)." Check Session".self::getWhiteBoardConfigIp()."===".$teacher_id;
